...
import {
  InputGroup, FormGroup, FormLabel
...
export default class ElementTypeFilter extends React.PureComponent<IProps, IState> {
      ...
      <FormGroup>
        <FormLabel>
          ...
          {this.state.filterCollapsed ?
            (<BsArrowsCollapse onClick={this.onFilterCollapse}/>) :
            (<BsArrowsExpand onClick={this.onFilterCollapse}/>)
          }
  ...
  private onToggle = (elementType: ElementType, event: React.FormEvent<any>) => {
