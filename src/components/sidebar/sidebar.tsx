...
import { BsArrowsAngleExpand, BsArrowsCollapseVertical, BsLayoutTextWindow } from 'react-icons/bs';
...
export default class Sidebar extends React.Component<IProps, IState> {
  ...
  public render() {
    return (
      ...
      >
        <ButtonGroup size="sm">
          <Button onClick={this.onSizeButtonClick.bind(this, SidebarWidth.Collapsed)} variant={this.widthStyle(SidebarWidth.Collapsed)}><BsArrowsCollapseVertical /></Button>
          <Button onClick={this.onSizeButtonClick.bind(this, SidebarWidth.Normal)} variant={this.widthStyle(SidebarWidth.Normal)}><BsLayoutTextWindow /></Button>
          <Button onClick={this.onSizeButtonClick.bind(this, SidebarWidth.Wide)} variant={this.widthStyle(SidebarWidth.Wide)}><BsArrowsAngleExpand /></Button>
        </ButtonGroup>
        <ModelInfo
