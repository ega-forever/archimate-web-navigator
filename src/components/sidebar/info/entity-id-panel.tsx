...
export default class EntityIdPanel extends React.PureComponent<IProps> {
  ...
  private entityContent(): React.JSX.Element {
    const entity = this.props.entity;
  ...
  private diagramContent(): React.JSX.Element {
  ...
  private relationshipContent(): React.JSX.Element {
  ...
  private elementContent(): React.JSX.Element {
