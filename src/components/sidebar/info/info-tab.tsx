...
export default class InfoTab extends React.PureComponent<IProps> {
  ...
  private elements(): React.JSX.Element | undefined {
  ...
  private relationships(): React.JSX.Element | undefined {
    if (
  ...
  private views(): React.JSX.Element | undefined {
    if (
      this.props.entity instanceof Diagram ||
      this.props.entity instanceof Element ||
  ...
  private properties(): React.JSX.Element | undefined {
